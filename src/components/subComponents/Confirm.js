...
const Confirm = () => {
	...
	return (
		<div className="relative bg-black/70 mx-auto max-h-80 w-[95%] max-w-[450px] sm:w-[80%] md:w-1/2 rounded-lg aspect-video border border-gray-400 flex justify-center items-center">
